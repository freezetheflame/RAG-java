...
if __name__ == '__main__':
    my_cookie = "0UGL0iUsNmtlO7oq6cA5upplUbjIE2pXQqfGYrxpz29m9sNGIh8dzQylhPIJfQKD"
    parser = argparse.ArgumentParser(description='从语雀下载书籍文档。')
    parser.add_argument('url', nargs='?', default="https://www.yuque.com/tulingzhouyu/db22bv", help='书籍的 URL。')
    parser.add_argument('--cookie', default="0UGL0iUsNmtlO7oq6cA5upplUbjIE2pXQqfGYrxpz29m9sNGIh8dzQylhPIJfQKD", help='用于认证的 Cookie。')
    parser.add_argument('--output', default="data", help='下载文件的输出目录。')
